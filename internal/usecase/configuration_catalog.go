...
var configurationTypes = map[string]string{
	...
	"TENANT_REGISTRATION_OPEN":         "boolean",
	"PUBLIC_CATALOG_OPEN":              "boolean",
	"CATALOG_POLICY_CACHE_TTL_SECONDS": "integer", "CATALOG_POLICY_TIMEOUT_MS": "integer",
...
var configurationDefaults = map[string]string{
	...
	"TENANT_REGISTRATION_OPEN": "applied true",
	"PUBLIC_CATALOG_OPEN":      "applied true", "CATALOG_POLICY_CACHE_TTL_SECONDS": "15", "CATALOG_POLICY_TIMEOUT_MS": "2000",
...
var configurationDescriptions = map[string]string{
	...
	"TENANT_REGISTRATION_OPEN":                "Platform switch that lets new tenants register; false closes new-tenant registration.",
	"PUBLIC_CATALOG_OPEN":                     "Platform switch for the public class catalog; false hides every class from catalog list and detail without changing classes or tenants.",
	"CATALOG_POLICY_CACHE_TTL_SECONDS":        "How long academic reuses one public catalog policy read before asking identity again.",
	"CATALOG_POLICY_TIMEOUT_MS":               "Per-call bound for academic's public catalog policy read; a timeout hides the catalog.",
